      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-primary-600 to-secondary-500 text-white py-3 rounded-lg font-bold hover:opacity-90 transition-opacity shadow-md disabled:opacity-70"
          >
